...
- **Frontend Moderno**: Interfaz React + Vite + TailwindCSS con diseño profesional
...
- **API REST**: http://127.0.0.1:8000/api/pedidos/
...
1. **Dashboard**: Vista general con estadísticas y pedidos recientes
2. **Pedidos**: Lista completa de pedidos con detalles
3. **Crear Pedido**: Formulario intuitivo para crear nuevos pedidos
4. **Productos**: Catálogo visual de productos con stock y precios
5. **Clientes**: Lista de clientes registrados
...
- **Componentes UI**: Estilo shadcn/ui con diseño moderno
